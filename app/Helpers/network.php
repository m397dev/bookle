 ...
 */
function get_user_system_info(string $user_agent): string
{
    $os_platform = 'Unknown';
    $os_array    = [
 ...
 * This function return user's browser information.
 */
function get_user_browser_info(string $user_agent): string
{
    $browser       = 'Unknown';
    $browser_array = [
 ...
 */
function get_user_device_info(string $user_agent): string
{
    $tablet_browser = 0;
    $mobile_browser = 0;
